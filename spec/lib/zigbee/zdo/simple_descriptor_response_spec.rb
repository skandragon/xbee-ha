...
describe Zigbee::ZDO::SimpleDescriptorResponse do
  ...
  it "encodes with input and output clusters" do
    ...
    expect(z.encode).to eq([ 0x11, 0x33, 0x22, 0x0a, 0x44, 0x66, 0x55, 0x88, 0x77, 0x05, 0x02, 0x22, 0x11, 0x44, 0x33, 0x02, 0x66, 0x55, 0x88, 0x77 ])
  end
  ...
  it "encodes with input clusters" do
    ...
    expect(z.encode).to eq([ 0x11, 0x33, 0x22, 0x0a, 0x44, 0x66, 0x55, 0x88, 0x77, 0x05, 0x02, 0x22, 0x11, 0x44, 0x33, 0x00 ])
  end
  ...
  it "encodes with output clusters" do
    ...
    expect(z.encode).to eq([ 0x11, 0x33, 0x22, 0x0a, 0x44, 0x66, 0x55, 0x88, 0x77, 0x05, 0x00, 0x02, 0x66, 0x55, 0x88, 0x77 ])
  end
