...
require 'zigbee/zdo/match_descriptor_request'

describe Zigbee::ZDO::MatchDescriptorRequest do

  it "decodes with input and output clusters" do
    bytes = [ 0x11, 0x22, 0x33, 0x44, 0x01, 0xaa, 0xbb, 0x01, 0xcc, 0xdd ]
    z = Zigbee::ZDO::MatchDescriptorRequest.decode(bytes)
